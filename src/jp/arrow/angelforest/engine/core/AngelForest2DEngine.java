...
public abstract class AngelForest2DEngine {
	...
	/**
	 * draws the polygon. It can control width, height, and angle.
	 * 
	 * @param gl
	 */
	...
	/**
	 * draws the polygon. It can control angle only.
	 * 
	 * It can be used only on TexturePolygon. When used with SquarePolygon, the
	 * width and Height of the square will be 1px x 1px.
	 * 
	 * @param gl
	 */
	...
	/**
	 * draws the polygon. It controls xy only.
	 * 
	 * It can be used only on TexturePolygon. When used with SquarePolygon, the
	 * width and Height of the square will be 1px x 1px.
	 * 
